...
public class LimitAccessAspect {
    ...
    public Semaphore retrieveSemaphore(LimitAccess limitAccess) {
        if (!Objects.equals(limitAccess.semaphoreName(), "default")) {
            return semaphoreMap.get(limitAccess.semaphoreName());
        }
